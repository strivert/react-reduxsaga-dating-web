...
export default (props) => (
  <div className="onboarding onboarding__often__church">
    <h1>How often do I attend church?</h1>

    <div className="box-options center">
      <div className="box-option small-image" onClick={()=> props.goNext('attendance', 'nearly every day', props.currentPath)}>
        <img src={PngCalendarDaily} alt="Daily" />
        <span>Daily</span>
      </div>
      <div className="box-option small-image" onClick={()=> props.goNext('attendance', 'every week', props.currentPath)}>
        <img src={PngCalendarWeekly} alt="Weekly" />
        <span>Weekly</span>
      </div>
      <div className="box-option small-image" onClick={()=> props.goNext('attendance', 'once a year', props.currentPath)}>
        <img src={PngCalendarMonthly} alt="Few times a year" />
        <span>Few times a year</span>
      </div>
      <div className="box-option other small-image" onClick={()=> props.goNext('attendance', 'rarely', props.currentPath)}>
